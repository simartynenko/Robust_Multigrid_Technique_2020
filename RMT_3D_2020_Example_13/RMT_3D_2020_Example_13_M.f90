!
! Numerical solution of model BVP on the multigrid structure generated by uniform grid
! Smoother is block Seidel iterations    
!
! Chapter III, Section 4
!
! File: RMT_3D_2020_Example_13_M.f90
! File: RMT_3D_2020_Example_13_1.f90
! File: RMT_3D_2020_Example_13_2.f90
!    
program RMT_3D_2020_Example_13_M
USE     RMT_3D_2020_Example_13_1                                               
USE     RMT_3D_2020_Example_13_2                                            
USE     RMT_3D_2020                                                     ! 001   
USE     RMT_3D_UFG                                                      ! 002

 NXX_FG = 100; N_coarsest_X = 5; LevelXd = 0; NX_block = 3; a_ = 0.9d0  ! 003  
 NYY_FG = 100; N_coarsest_Y = 5; LevelYd = 0; NY_block = 3; b_ = 0.9d0  ! 004
 NZZ_FG = 100; N_coarsest_Z = 5; LevelZd = 0; NZ_block = 3; c_ = 0.9d0  ! 005
 
  q_max = 15; NSIL = 5; ResLIM = 1.e-6                                  ! 006 
 ...
 open(1,file='RMT_3D_2020_Example_13.res')
...
end program RMT_3D_2020_Example_13_M
